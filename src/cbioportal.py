...
def find_studies_by_cancer_type(cancer_type_query):
    ...
    search term, ranked by sample count (largest first) so well-powered,
    well-known studies (e.g. TCGA PanCancer Atlas cohorts) surface before
    small niche subtype studies with only a handful of samples.
